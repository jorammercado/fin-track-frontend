        ...
        <div className="home-page">
            <section className="hero-section-home text-white text-center">
                <div className="container">
                    ...
                    <p className="lead">
                        Track your income, manage expenses, and make smart investment decisions
                        easily.
                    </p>
                    <Link to="/signup">
                        <HomeButton>Get Started Today</HomeButton>
                    </Link>
                </div>
            </section>
                            ...
                            <div className="card feature-card-home">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        Input income and expenses to get a clear view of your
                                        disposable income.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="card feature-card-home">
                                <div className="card-body">
                                    ...
                                    <h5 className="card-title mt-3">
                                        AI Recommendations (comming soon)
                                    </h5>
                                    <p className="card-text">
                                        Receive personalized, low-risk stock recommendations based
                        ...
                        <div className="col-md-4">
                            <div className="card feature-card-home">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        Visualize potential earnings over time based on your data
                                        investments.
                                    </p>
                                </div>
                            </div>
            ...
            <section className="real-time-stock-section py-5">
                <div className="container">
                    <div className="text-center">
                        ...
                        <p className="lead">
                            Stay updated with the latest stock prices to make informed investment
                            decisions.
                        </p>
                    </div>
                </div>
