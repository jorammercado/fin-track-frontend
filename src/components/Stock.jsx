...
export default function Stock({ stock }) {
    return (
        <tr className="transactions__container__table__row-values">
            ...
            <td className="transactions__container__table__row-values__cell">{stock.day.v?.toFixed(2)}</td>
            ...
            <td className="transactions__container__table__row-values__cell">{stock.prevDay.v?.toFixed(2)}</td>
