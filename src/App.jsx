        ...
        <div className="app">
            <Router>
                <div className="app__nav">
                    <NavBar token={token} handleLogout={handleLogout} currentUser={currentUser} />
                </div>
                <main className="app__main">
                    <Routes>
                        ...
                        <Route
                            ...
                            element={
                                <ProtectedRoute element={Transactions} currentUser={currentUser} />
                            }
                        />

                        <Route
                            path="/users/:account_id/profile/investments"
                            element={<ProtectedRoute element={Ivestments} />}
                        />

                        <Route
                            path="/users/:account_id/profile/marketnews"
                            element={<ProtectedRoute element={MarketNews} />}
                        />

                        <Route
                            path="/users/:account_id/profile/dashboard"
                            element={
                                <ProtectedRoute element={Dashboard} currentUser={currentUser} />
                            }
                        />
                        ...
                        <Route path="*" element={<PublicRoute element={FourOFour} />} />
                    </Routes>
                </main>
